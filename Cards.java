...
public class Cards {
	private final static String MAGIC_CARD = "magic", UPGRADE_CARD = "upgrade", DOWNGRADE_CARD = "downgrade", 
			MAGIC_UNICORN = "special", BASIC_UNICORN = "basic", BABY_UNICORN = "baby", INSTANT_CARD = "instant";
	private final static int DISCARD_ON_DEATH = 0, BRING_TO_HAND_ON_DEATH = 1, BRING_TO_NURSERY_ON_DEATH = 2, 
	...
	private List<IndCards> mainDeck = new ArrayList<IndCards>(), nurseryDeck = new ArrayList<IndCards>();
	private final static boolean BASIC_IS_NEEDED = true, BASIC_IS_NOT_NEEDED = false; 
	
	
	public static List<IndCards> getNursery(){
		return nurseryDeck;
	}
	public static List<IndCards> getMainDeck (){
		return mainDeck;
	}
	public static void startingDecks(){
		generateDeck();
		generateNursery();
	}
	public static void shuffleDecks(){
		Collections.shuffle(mainDeck);
		Collections.shuffle(nurseryDeck);
	}
	...
	private static void generateNursery(){
